	...
	<div id="post-<?php the_ID(); ?>" <?php post_class(array('team-person', 'centered-box', 'default-background')); ?>>
		...
		<div class="team-person-info">
			...
			<?php if(!empty($thegem_item_data['phone'])) : ?>
				<div class="gem-styled-color-1"><div class="team-person-phone title-h4"><a href="<?php echo esc_url('tel:'.$thegem_item_data['phone']); ?>"><?php echo esc_html($thegem_item_data['phone']); ?></a></div></div>
			<?php endif; ?>
