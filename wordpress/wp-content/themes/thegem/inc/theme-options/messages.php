...
return array(
    ...
    'info' => array (
        ...
        'single_pages_post_builder_template' => __('<p>Select blog post template. You can create new blog post templates in <a href="'.get_site_url().'/wp-admin/edit.php?post_type=thegem_templates&templates_type=single-post" target="_blank">Templates Builder -> Single Post</a></p>', 'thegem'),
        ...
        'woocommerce_product_archive_filter_by_categories_order' => __('Appearance order for product categories.', 'thegem'),
        ...
        'popups_layout_source_product_categories' => __('<p>Here you can enable or disable popups for all product categories. Select "Default Settings" to inherit popups from <a href="'.get_site_url().'/wp-admin/admin.php?page=thegem-theme-options#/general/popups">General -> Popups</a> section of Theme Options.</p>', 'thegem'),
