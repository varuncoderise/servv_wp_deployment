...
<?php } else { ?>
	...
	<div class="meta">
		<strong class="woocommerce-review__author title-h6"><?php comment_author(); ?> </strong>
		<?php
		...
		?>
		<time class="woocommerce-review__published-date date-color small-body" datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>"><?php echo esc_html( get_comment_date( wc_date_format() ) ); ?></time>
	</div>
