...
<form id="yith-wcwl-form" action="<?php echo esc_attr( $form_action ); ?>" method="post" class="woocommerce yith-wcwl-form wishlist-fragment<?php echo (thegem_checkout_get_type() == 'one-page-modern' ? ' woocommerce-wishlist-modern' : ''); ?>" data-fragment-options="<?php echo esc_attr( json_encode( $fragment_options ) ); ?>">
