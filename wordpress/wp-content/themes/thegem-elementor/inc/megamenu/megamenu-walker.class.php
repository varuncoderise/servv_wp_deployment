...
class TheGem_Mega_Menu_Walker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if (true) {
			...
			if (thegem_is_plugin_active('elementor/elementor.php') && !\Elementor\Plugin::$instance->preview->is_preview_mode() && $depth == 0 && $mega_data['enable'] && $mega_data['source'] == 'template' && !empty($mega_data['template']) && get_post_meta($mega_data['template'], 'thegem_template_type', true) == 'megamenu') {
