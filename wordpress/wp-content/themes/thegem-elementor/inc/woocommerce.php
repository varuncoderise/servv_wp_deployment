...
function thegem_woocommerce_scripts() {
	...
	if(thegem_is_plugin_active('woocommerce/woocommerce.php')) {
		...
		if (( is_shop() || is_product_taxonomy() || is_product() || is_cart() ) && thegem_get_option('product_archive_layout_source') == 'default' && thegem_get_option('product_archive_type') == 'grid') {
...
if (!function_exists('thegem_extended_products_more_callback')) {
	function thegem_extended_products_more_callback() {
		...
		if ((isset($params['source']) && in_array('category', $params['source']) && !empty($params['content_products_cat'])) || !empty($params['content_products_cat_filter'])) {
		...
		if (!empty($params['source']) && in_array('tag', $params['source'])) {
			$tag = $params['content_products_tags'];
		}
		...
		$attributes = [];
		if ((isset($params['source']) && in_array('attribute', $params['source']) && !empty($params['content_products_attr'])) || !empty($params['content_products_attr_filter'])) {
...
if (!function_exists('get_thegem_extended_products_render_item_image_sizes')) {
	function get_thegem_extended_products_render_item_image_sizes($params, $thegem_highlight_type = 'disabled') {
		...
		if (isset($params['layout']) && $params['layout'] == 'masonry') {
			...
			if (isset($params['fullwidth_section_images']) && ($params['fullwidth_section_images'] == '1' || $params['fullwidth_section_images'] == 'yes')) {
...
if (!function_exists('thegem_extended_products_render_item')) {
	function thegem_extended_products_render_item($params, $item_classes, $thegem_sizes = null, $post_id = false, $is_cat = false, $is_elementor_widget = false, $is_carousel = false) {
		...
		if ($params['product_show_add_to_cart_mobiles'] != '1' && $params['product_show_add_to_cart_mobiles'] != 'yes') {
			...
			if ($params['product_show_wishlist'] != 'yes' && $params['product_show_wishlist'] != '1' && $params['social_sharing'] != 'yes' && $params['social_sharing'] != '1') {
