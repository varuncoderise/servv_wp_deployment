					...
					<div class="highlight-item-alternate-box-content caption">
						<div class="highlight-item-alternate-box-content-inline">
							...
							<?php if ($settings['blog_show_title'] == 'yes') {
								...
								} else if ($settings['thegem_elementor_preset'] == 'new' || ($settings['thegem_elementor_preset'] == 'list' && $settings['columns'] == '1x')) {
									$title = 'title-h4';
								} else if ($settings['thegem_elementor_preset'] == 'list' && in_array($settings['columns'], ['3x', '4x'])) {
			...
			<div class="wrap clearfix">
				...
				<?php if ($settings['caption_position'] == 'hover' || (!isset($settings['blog_show_featured_image']) || $settings['blog_show_featured_image'] == 'yes')) { ?>
					<div <?php post_class($thegem_image_classes); ?>>
						<div class="image-inner <?php echo $thegem_has_post_thumbnail ? '' : 'without-image'; ?>">
							...
							<?php if ($settings['layout'] == 'justified' || $settings['layout'] == 'creative' || (!$thegem_has_post_thumbnail && isset($settings['search']) && !in_array($post_format, array('quote', 'audio', 'video'))) ): ?>
							...
							<?php if (!$thegem_has_post_thumbnail && isset($settings['search']) && !in_array($post_format, array('quote', 'audio', 'video'))) { ?>
						...
						<?php if (($post_format != 'video' || $thegem_has_post_thumbnail) && $post_format != 'audio' && $post_format != 'quote' && $post_format != 'gallery' && $settings['image_hover_effect'] != 'simple-zoom'): ?>
							<div class="overlay">
										...
										<div class="caption">
											...
											<?php if ($post_format != 'video'): ?>
												<?php if ($settings['caption_position'] == 'page' && $version == 'new'):
													if ($settings['icon_hover_show'] == 'yes') { ?>
													...
													if ($settings['blog_show_categories'] == 'yes' && $post_format != 'quote'): ?>
														<div class="info">
															<?php
															$thegem_index = 0;
															foreach ($slugs as $thegem_k => $thegem_slug)
				...
				<?php if ( $settings['caption_position'] == 'page' && $post_format != 'quote'): ?>
					...
					<?php endif; ?>
						...
						<?php if ($version == 'new' && (!empty($post_excerpt) || $has_comments || $has_likes || $settings['social_sharing'] == 'yes')): ?>
							<?php if (!empty($post_excerpt) && $settings['blog_show_description'] == 'yes'):
								$description_preset = '';
								if (isset($settings['blog_description_preset']) && $settings['blog_description_preset'] != 'default') {
									$description_preset = $settings['blog_description_preset'];
							...
							<?php if ($settings['thegem_elementor_preset'] == 'list' && $settings['blog_show_readmore_button'] == 'yes') { ?>
				...
				<div class="wrap clearfix">
					...
					<?php if ( $settings['caption_position'] == 'page' ): ?>
						...
						<?php endif; ?>
							...
							<?php if ( $version == 'new' && ( $settings['blog_show_description'] == 'yes' || $settings['social_sharing'] == 'yes' ) ): ?>
