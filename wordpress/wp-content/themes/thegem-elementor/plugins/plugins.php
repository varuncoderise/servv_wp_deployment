...
function thegem_downgrade() {
	...
	$plugin_info->package = 'http://democontent.codex-themes.com/plugins/thegem-elementor/required/old/thegem-elements-elementor-5.2.1.zip';
	$plugin_info->url = '';
	...
	$theme_updates->response['thegem-elementor'] = array(
		'package' => 'http://democontent.codex-themes.com/plugins/thegem-elementor/theme/old/thegem-elementor-5.2.1.1.zip',
		'url' => '',
		'new_version' => '',
	);
