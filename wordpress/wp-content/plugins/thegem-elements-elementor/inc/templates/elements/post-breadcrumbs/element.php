...
namespace TheGem_Elementor\Widgets\TemplatePostBreadcrumbs;
...
class TheGem_TemplatePostBreadcrumbs extends Widget_Base {
	...
	public function get_name() {
		return 'thegem-template-post-breadcrumbs';
	}
	...
	public function get_title() {
		return __('Post Breadcrumbs', 'thegem');
	}
	...
	public function get_widget_wrapper() {
		return 'thegem-te-post-breadcrumbs';
	}
	...
	public function get_customize_class($only_parent = false) {
		...
		return ' .'.$this->get_widget_wrapper().' .post-breadcrumbs';
	}
...
\Elementor\Plugin::instance()->widgets_manager->register(new TheGem_TemplatePostBreadcrumbs());
