...
namespace TheGem_Elementor\Widgets\WC_Hook;
...
/**
 * Elementor widget for WC_Hook.
 */
class TheGem_WC_Hook extends Widget_Base {
	...
	public function get_title() {
		return __('WooCommerce Hook', 'thegem');
	}
...
\Elementor\Plugin::instance()->widgets_manager->register(new TheGem_WC_Hook());