...
$textbox_container_link = $this->get_textbox_link_url( $settings );
	...
	$this->add_render_attribute( 'textbox_content', 'class', 'gem-infobox-content' );
	...
	if( ! empty( $settings['textbox_content_icon_image_horizontal_position'] ) ) {
		$this->add_render_attribute( 'textbox_content', 'class', 'gem-infobox-icon-horizontal-'.$settings['textbox_content_icon_image_horizontal_position'] );
	}

	if( ! empty( $settings['textbox_content_icon_image_text_wrapping'] ) ) {
		$this->add_render_attribute( 'textbox_content', 'class', 'gem-infobox-icon-image-wrapping-'.$settings['textbox_content_icon_image_text_wrapping'] );
	}

?>

<div class="gem-infobox <?php echo !empty( $settings['thegem_elementor_preset'] ) ? 'styled-textbox-' . esc_attr( $settings['thegem_elementor_preset'] ) : '' ?> <?php echo !empty( $textbox_container_link ) ? 'width-link' : ''; ?>">

	<?php if ( ! empty( $settings['textbox_container_top_shape'] ) ) :
		$top_style = $settings['textbox_container_top_shape']; ?>

		<div class="gem-infobox-top gem-infobox-top-<?php echo esc_attr( $top_style ); ?> default-fill">
			<?php
			...
			<div class="gem-texbox-text-wrapper">
				...
				<?php if ( $settings['source'] === 'editor' ) : ?>
					<?php if ( ! empty( $settings['content_textbox_title'] ) ) :
						...
						$this->add_render_attribute( 'content_textbox_title', 'class', 'gem-infobox-title' );
					...
					<?php if ( ! empty( $settings['content_textbox_subtitle'] ) ) :
						...
						$this->add_render_attribute( 'content_textbox_subtitle', 'class', 'gem-infobox-subtitle' );
					...
					<?php if ( ! empty( $settings['content_textbox_text'] ) ) :
						$this->add_render_attribute( 'content_textbox_text', 'class', 'gem-infobox-description' );
	...
	if ( ! empty( $settings[ 'textbox_container_bottom_shape' ] ) ) :
		...
		<div class="gem-infobox-bottom gem-infobox-bottom-<?php echo esc_attr( $bottom_style ); ?> default-fill">
		<?php
