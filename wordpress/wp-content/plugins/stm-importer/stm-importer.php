...
if ( !function_exists('stm_demo_import'))
{
                ...
                <div class="stm_demo_import_choices">
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="New York" name="consulting_layout_demo" value="layout_1" checked/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="London" name="consulting_layout_demo" value="layout_6"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Frankfurt" name="consulting_layout_demo" value="layout_9"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Moscow" name="consulting_layout_demo" value="layout_5"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Shanghai" name="consulting_layout_demo" value="layout_2"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Madrid" name="consulting_layout_demo" value="layout_7"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Tokyo" name="consulting_layout_demo" value="layout_3"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Seoul" name="consulting_layout_demo" value="layout_8"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Sydney" name="consulting_layout_demo" value="layout_4"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Hong Kong" name="consulting_layout_demo" value="layout_10"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Paris" name="consulting_layout_demo" value="layout_11"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Singapore" name="consulting_layout_demo" value="layout_12"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Sao Paulo" name="consulting_layout_demo" value="layout_13"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Abu Dhabi" name="consulting_layout_demo" value="layout_14"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Dublin" name="consulting_layout_demo" value="layout_15"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Tel Aviv" name="consulting_layout_demo" value="layout_16"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Dubai" name="consulting_layout_demo" value="layout_17"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Tehran" name="consulting_layout_demo" value="layout_18"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Oslo" name="consulting_layout_demo" value="layout_19"/>
                    ...
                    <label>
						...
						<span class="stm_choice_radio_button">
							<input type="radio" data-name="Rome" name="consulting_layout_demo" value="layout_20"/>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function() {
                jQuery('#import_demo_data_form').on('submit', function() {
                    ...
                    $site_name = jQuery(this).parents().find('.stm_demo_import_choices input[name=consulting_layout_demo]:checked').attr('data-name');
                    ...
                    jQuery.ajax({
                        ...
                        success: function(res){
                            ...
                            if( res == 'error'){
                                jQuery('.stm_message.errors').slideDown();
                            }else{
    ...
    function stm_demo_import_content() {
		...
		$ready = prepare_demo( 'demo_' . $consulting_layout );
		if( $ready ){
			ob_start();
