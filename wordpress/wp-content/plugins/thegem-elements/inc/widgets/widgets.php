...
class The_Gem_Widget_ProjectInfo extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ($widget_data['icon_pack'] == 'thegem-header') {
...
class The_Gem_Widget_Gallery extends WP_Widget {
	...
	function __construct() {
		parent::__construct('thegem_gallery', __('TheGem Gallery', 'thegem'), array('classname' => 'widget_thegem_gallery', 'description' => __('TheGem Gallery', 'thegem')));
	}
...
class The_Gem_Widget_Clients extends WP_Widget {
	...
	function __construct() {
		parent::__construct('The_Gem_Widget_Clients', __('TheGem Clients', 'thegem'), array('classname' => 'widget_thegem_clients', 'description' => __('TheGem Clients', 'thegem')));
	}
...
class The_Gem_Widget_Template extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if($widget_data['id'] > 0 && $template = get_post($widget_data['id'])) {
			...
			$custom_css = get_post_meta($widget_data['id'], '_wpb_shortcodes_custom_css', true) . get_post_meta($widget_data['id'], '_wpb_post_custom_css', true);
			if($custom_css) {
