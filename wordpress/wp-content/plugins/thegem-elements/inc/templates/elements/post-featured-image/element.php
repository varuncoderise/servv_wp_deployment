...
class TheGem_Template_Element_Post_Featured_Image extends TheGem_Single_Post_Template_Element {
	...
	public function shortcode_output($atts, $content = '') {
        ...
        <div <?php if (!empty($params['element_id'])): ?>id="<?=esc_attr($params['element_id']); ?>"<?php endif;?>
             class="thegem-te-post-featured-image <?= esc_attr($params['element_class']); ?> <?= esc_attr($uniqid); ?>">
...
$templates_elements['thegem_te_post_featured_image'] = new TheGem_Template_Element_Post_Featured_Image();
$templates_elements['thegem_te_post_featured_image']->init();
