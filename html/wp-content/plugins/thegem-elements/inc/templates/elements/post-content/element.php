...
class TheGem_Template_Element_Post_Content extends TheGem_Single_Post_Template_Element {
	...
	public function shortcode_output($atts, $content = '') {
		...
		if ($params['text_transform'] != '') {
			$custom_css .= $customize.' .post-content {text-transform: ' . $params['text_transform'] . ';}';
		}
	...
	public function shortcode_settings() {
		...
		return array(
			...
			'icon' => 'thegem-icon-wpb-ui-element-post-content',
...
$templates_elements['thegem_te_post_content'] = new TheGem_Template_Element_Post_Content();
$templates_elements['thegem_te_post_content']->init();
