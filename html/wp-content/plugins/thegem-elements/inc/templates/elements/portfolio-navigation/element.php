...
class TheGem_Template_Element_Portfolio_Navigation extends TheGem_Portfolio_Item_Template_Element {

	public function __construct() {
	}

	public function get_name() {
		return 'thegem_te_portfolio_navigation';
	}
	...
	public function shortcode_output($atts, $content = '') {
		...
		), $atts, 'thegem_te_portfolio_navigation');
		...
		//Custom Styles
		$customize = '.thegem-te-portfolio-navigation.'.$uniqid;
		$custom_css = '';
		...
		<div <?php if (!empty($params['element_id'])): ?>id="<?= esc_attr($params['element_id']); ?>"<?php endif; ?> class="thegem-te-portfolio-navigation <?= esc_attr($params['element_class']); ?> <?= esc_attr($uniqid); ?>">
			<?= $return_html ?>
		</div>
	...
	public function shortcode_settings() {
		...
		return array(
			'name' => __('Prev/Next Navigation', 'thegem'),
			'base' => 'thegem_te_portfolio_navigation',
			'icon' => 'thegem-icon-wpb-ui-element-portfolio-navigation',
			'category' => __('Portfolio Page Builder', 'thegem'),
			'description' => __('Prev/Next Navigation (Portfolio Page Builder)', 'thegem'),
			'params' => array_merge(
...
$templates_elements['thegem_te_portfolio_navigation'] = new TheGem_Template_Element_Portfolio_Navigation();
$templates_elements['thegem_te_portfolio_navigation']->init();
